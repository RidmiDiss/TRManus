...
from src.trading_engine import ForexTradingRobot
import threading
import logging
...
trading_robot = ForexTradingRobot()
trading_thread = None
...
def analyze_symbol(symbol):
    ...
    try:
        # Add =X suffix if not present (for Yahoo Finance forex symbols)
        ...
        return jsonify({
            "symbol": symbol,
            "signals": signals,
            "timestamp": trading_robot.data_provider.get_real_time_price(symbol)
        })
